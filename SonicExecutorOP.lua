...
TextLabel.Text = "SonicTuru   Executor"
...
Source.Text = "-- Welcome Back SonicTeam"
...
Source_2.Text = "-- Welcome Back SonicTeam"
...
Execute.TextColor3 = Color3.fromRGB(0, 255, 0)
...
BlueLight.BackgroundColor3 = Color3.fromRGB(0, 255, 0)
BlueLight.BorderColor3 = Color3.fromRGB(0, 255, 0)
...
TextLabel_5.Text = "Made By SonicTuru#1033"
...
ImageLabel_4.Image = "rbxassetid://8834748103"
...
TextLabel_6.Text = "Disabled By SonicTuru!"
...
FloatingGUI.Image = "rbxassetid://8834748103"
...
local function FJVQORH_fake_script() -- DexExplorer.LocalScript 
	...
	btn.MouseButton1Click:Connect(function()
		loadstring(game:HttpGet("https://raw.githubusercontent.com/NickelHUBB/Sonic-HUB/main/All-Game-Script"))()
	end)
end
...
local function QHYNL_fake_script() -- RemoteSpy.LocalScript 
	...
	btn.MouseButton1Click:Connect(function()
		loadstring(game:HttpGet("https://pastebin.com/raw/DgCAMAmN"))();
	end)
end
...
local function HYBOB_fake_script() -- UnamedEsp.LocalScript 
	...
	btn.MouseButton1Click:Connect(function()
		loadstring(game:HttpGet("https://pastebin.com/raw/WrrG9tkf"))()
	end)
end
...
local function RZTRLAR_fake_script() -- HoHoHub.LocalScript 
	...
	btn.MouseButton1Click:Connect(function()
		loadstring(game:HttpGet("https://raw.githubusercontent.com/NickelHUBB/Ddddhg/main/Sonic-HUB-BF"))()
	end)
end
